...
class Problem:
    ...
    def getTestcases(self) -> list:
        ...
        inputs = [inp.pre.get_text("\n")
                  for inp in sampleTests.find_all(class_="input")]
        outputs = [out.pre.get_text("\n")
                   for out in sampleTests.find_all(class_="output")]
